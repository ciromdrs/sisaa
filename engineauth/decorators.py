...
def alu_required(metodo):
    ...
    :returns:
        O método chamado, se self.usuario.alu_flag; ou
        O método requer_permissao() do handler.
    '''
    def checar(self, *args, **kwds):
            if self.usuario:
                if self.usuario.alu_flag:
                    return metodo(self, *args, **kwds)
                else:
...
def ava_required(metodo):
    ...
    :returns:
        O método chamado, se self.usuario.ava_flag; ou
        O método requer_permissao() do handler.
    '''
    def checar(self, *args, **kwds):
            if self.usuario:
                if self.usuario.ava_flag:
                    return metodo(self, *args, **kwds)
                else:
...
def org_required(metodo):
    ...
    :returns:
        O método chamado, se self.usuario.org_flag; ou
        O método requer_permissao() do handler.
    '''
    def checar(self, *args, **kwds):
            if self.usuario:
